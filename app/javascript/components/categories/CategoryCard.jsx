...
export default ({ category, categories, setCategories, setAlert }) => {
  ...
  const onUpdate = async () => {
    if (title && color && color.length === 7) {
      try {
        ...
        setCategories(
          categories.map((data) =>
            data.id === category.id ? { title, color, id: category.id } : data
          )
        );
        setToggleEdit(false);
      } catch ({ response: { data } }) {
      ...
      <td className="border px-4 py-2">
        {!toggleEdit ? (
          <svg
            ...
            viewBox="0 0 128 128"
            width="20"
            className="mx-auto fill-current w-full"
            title="Edit"
          ...
          >
            <g>
              <path
                d="m87.673 22.047h10.545v26.015h-10.545z"
                fill="#65727f"
                transform="matrix(.707 -.707 .707 .707 2.436 75.99)"
              />
              <path
                d="m14.707 56.638h87.294v26.015h-87.294z"
                fill="#54b88b"
                transform="matrix(.707 -.707 .707 .707 -32.156 61.661)"
              />
              <path
                d="m93.398 10.412h22.363v26.015h-22.363z"
                fill="#ffca28"
                transform="matrix(.707 -.707 .707 .707 14.071 80.809)"
              />
              <path
                d="m36.689 109.707-30.374 11.978 11.978-30.374z"
                fill="#9b6e42"
              />
              <path d="m19.11 116.64-12.79 5.04 5.04-12.79z" fill="#65727f" />
              <g>
                <path d="m122.922 23.474-18.4-18.4a1.75 1.75 0 0 0 -2.474 0l-61.773 61.78a1.75 1.75 0 1 0 2.475 2.475l37.269-37.269 3.5 3.5-59.248 59.254-3.5-3.5 6.855-6.855a1.75 1.75 0 0 0 -2.475-2.475l-8.092 8.093a1.649 1.649 0 0 0 -.119.146c-.026.032-.054.061-.078.095a1.746 1.746 0 0 0 -.191.349l-6.93 17.56v.006l-5.054 12.809a1.751 1.751 0 0 0 2.271 2.271l12.809-5.052 17.559-6.925a1.773 1.773 0 0 0 .349-.191c.034-.024.063-.052.1-.078a1.794 1.794 0 0 0 .145-.119l61.727-61.726v-.005l7.45-7.449 3.228-3.227a1.75 1.75 0 0 0 -2.475-2.475l-1.992 1.993-15.908-15.93 13.339-13.338 15.921 15.92-5.378 5.378a1.75 1.75 0 0 0 2.475 2.475l6.615-6.616a1.75 1.75 0 0 0 0-2.474zm-36.922 14.563 3.963 3.963-59.251 59.255-3.967-3.967zm-49.311 69.195-3.5-3.5 59.248-59.254 3.5 3.5zm-24.678 4.78 3.977 3.977-6.567 2.59zm7.526 2.577-6.126-6.126 5.532-14.028 4.088 4.088 6.436 6.436 4.088 4.088zm83.863-74.065-4.981 4.982-15.925-15.921 4.982-4.985z" />
                <path d="m32.21 79.144a1.745 1.745 0 0 0 1.238-.513l3.181-3.181a1.75 1.75 0 1 0 -2.475-2.474l-3.181 3.18a1.751 1.751 0 0 0 1.237 2.988z" />
              </g>
            </g>
          </svg>
        ) : (
      ...
      <td className="border px-4 py-2">
        ...
        >
          <g>
            <g>
              <path
                d="m399.5 183.966h-292.461l30.787 288.207c1.911 17.885 17.002 31.45 34.989 31.45h160.91c17.987 0 33.078-13.565 34.989-31.45z"
                fill="#ecf4ff"
              />
            </g>
            <g>
              <path
                d="m357.82 183.966-26.764 250.55c-1.91 17.885-17.002 31.45-34.989 31.45h-158.904l.663 6.207c1.91 17.885 17.002 31.45 34.989 31.45h160.91c17.987 0 33.078-13.565 34.989-31.45l30.786-288.207z"
                fill="#ddeafb"
              />
            </g>
            <g>
              <path
                d="m336.621 80.049-76.376-71.201c-2.635-2.456-6.934-1.409-8.116 1.993-6.629 19.082-17.247 37.126-31.908 52.852s-31.917 27.581-50.488 35.531c-3.311 1.417-4.055 5.78-1.42 8.236l76.374 71.2c2.885 2.69 7.079 3.424 10.717 1.901 18.983-7.949 36.624-19.96 51.57-35.992 14.977-16.066 25.738-34.55 32.334-54.089 1.246-3.692.162-7.774-2.687-10.431z"
                fill="#5e54ac"
              />
            </g>
            <g>
              <path
                d="m336.621 80.049-11.161-10.405c-5.975 11.141-13.459 21.707-22.486 31.39-14.945 16.031-32.587 28.043-51.57 35.992-3.638 1.524-7.832.789-10.717-1.901l-50.201-46.8c-6.676 4.207-13.616 7.844-20.753 10.899-3.311 1.417-4.054 5.78-1.42 8.236l76.374 71.2c2.885 2.69 7.079 3.424 10.717 1.901 18.983-7.949 36.624-19.96 51.57-35.992 14.977-16.066 25.738-34.55 32.334-54.089 1.246-3.692.162-7.774-2.687-10.431z"
                fill="#524798"
              />
            </g>
            <g>
